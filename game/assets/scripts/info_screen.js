...
function info_screen_render()
{
    ...
    SpriteBatch.drawText(font, "Controls", new Vector2(0, yPosition), Vector2.TOP_LEFT, titleColor);
    yPosition += textSize.y;
    ...
    yPosition += textSize.y;
    SpriteBatch.drawText(font, "Open the interacation menu by holding Space/Enter. Select an option by holding W,A,S,D or Up, Down, Left, Right arrows.", new Vector2(0, yPosition), Vector2.TOP_LEFT, textColor);
    yPosition += textSize.y;
