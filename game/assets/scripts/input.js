...
{
    return Input.isJustDown(Key.UP) || Input.isJustDown(Key.W) || GamePad.isJustDown(0, Button.DPAD_UP);
}

function input_is_up_down()
{
    return Input.isDown(Key.UP) || Input.isDown(Key.W) || GamePad.isDown(0, Button.DPAD_UP);
}

function input_is_down_just_down()
{
    return Input.isJustDown(Key.DOWN) || Input.isJustDown(Key.S) || GamePad.isJustDown(0, Button.DPAD_DOWN);
}

function input_is_down_down()
{
    return Input.isDown(Key.DOWN) || Input.isDown(Key.S) || GamePad.isDown(0, Button.DPAD_DOWN);
}

function input_is_left_just_down()
{
    return Input.isJustDown(Key.LEFT) || Input.isJustDown(Key.A) || GamePad.isJustDown(0, Button.DPAD_LEFT);
}

function input_is_left_down()
{
    return Input.isDown(Key.LEFT) || Input.isDown(Key.A) || GamePad.isDown(0, Button.DPAD_LEFT);
}

function input_is_right_just_down()
{
    return Input.isJustDown(Key.RIGHT) || Input.isJustDown(Key.D) || GamePad.isJustDown(0, Button.DPAD_RIGHT);
}
...
function input_is_any_direction_just_up()
{
    ...
    || GamePad.isDown(0, Button.DPAD_UP) || GamePad.isDown(0, Button.DPAD_DOWN) || GamePad.isDown(0, Button.DPAD_LEFT) || GamePad.isDown(0, Button.DPAD_RIGHT);
}
...
function input_is_vertical_direction_just_up()
{
    ...
    || GamePad.isDown(0, Button.DPAD_UP) || GamePad.isDown(0, Button.DPAD_DOWN);
}